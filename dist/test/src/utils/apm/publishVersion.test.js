...
describe('apm > publishVersion', () => {
    describe('Return valid tx data to publish a new version', () => {
        ...
        const contentUri = '0x33697066733a516d624e473864566769333633706f704b7943726f6a4d4e6a337752637a786a456f537632374a38747646677751';
        ...
        it('finance.aragonpm.eth in mainnet', async () => {
            ...
            const txData = await apm_1.publishVersion(appName, versionInfo, provider);
            ...
            chai_1.assert.deepEqual(txData, expectedTxData, 'wrong txData');
        });
...
//# sourceMappingURL=publishVersion.test.js.map